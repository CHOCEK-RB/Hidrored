...
class ImagenAdjuntaTest {
  ...
  void deberiaLanzarExcepcionConDatosInvalidos() {
    LocalDateTime fecha = LocalDateTime.now();
    assertThrows(IllegalArgumentException.class, () -> new ImagenAdjunta(null, "foto.jpg", "image/png", 100L, fecha));
    assertThrows(IllegalArgumentException.class, () -> new ImagenAdjunta("http://url", "", "image/png", 100L, fecha));
